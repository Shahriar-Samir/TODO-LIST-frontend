...
<div className="dropdown">
  ...
  <ul tabIndex={0} className="dropdown-content menu bg-gradient-to-r from-indigo-400 to-cyan-400 border-none text-white shadow-lg hover:bg-gradient-to-r  rounded-box z-10 w-52 p-2 ">
  <div>
    <label>Date</label> <br />
  <p>Today</p>
  </div>
 <div className="mt-2">
    <label>Time</label> <br />
 <input type="time" ref={timeRef} className="w-full border p-2 bg-transparent outline-none focus-within:outline-none"/>
 </div>
  </ul>
</div>

<div className="dropdown">
  <div tabIndex={0} role="button" className="btn bg-white m-1 bg-gradient-to-r from-indigo-400 to-cyan-400 border-none text-white shadow-lg hover:bg-gradient-to-r hover:from-indigo-500 hover:to-cyan-500">Reminder</div>
  <ul tabIndex={0} className="dropdown-content menu  rounded-box z-[1] w-52 p-2 bg-gradient-to-r from-indigo-400 to-cyan-400 border-none text-white shadow-lg ">
  <div className="mt-2">
    <label>Time</label> <br />
 <input type="time" ref={reminderRef} className="w-full border bg-transparent p-2 outline-none focus-within:outline-none"/>
 </div>
  </ul>
</div>
