...
const Notifications = () => {
  ...
  const { data: notifications, isFetching } = useQuery({
    ...
    queryFn: () =>
      axiosSecure.get(`/notifications/${user?.uid}`).then((res) => {
        return res.data;
      }),
  });
            ...
            {notifications?.map((item) => {
              return (
                <div key={item._id}>
                  ...
                  <div
                    className="p-3 border-y"
                    role="button"
                    onClick={() => markAsRead(item._id, 1)}
                  >
                      ...
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          >
                            {item?.title}{" "}
                            {item?.readStatus === false ? (
                              <span className="ms-2 text-gray-500 text-xs p-1 rounded-lg bg-gray-200">
                                New
                              </span>
                            ) : (
                              ""
                ...
                return (
                  <div key={item._id}>
                    ...
                    <div
                      ...
                      role="button"
                      onClick={() =>
                        document.getElementById(item._id + "2").showModal()
                      }
                    >
                      <div className="flex justify-between">
                        <div className="flex gap-4 items-center">
